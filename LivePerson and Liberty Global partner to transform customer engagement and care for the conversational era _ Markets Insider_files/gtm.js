...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_fieldsToSet":["list",["map","fieldName","anonymizeIp","value","true"]],
      "vtp_enableLinkId":false,
      "vtp_dimension":["list",["map","index","1","dimension","MarketsInsider"],["map","index","4","dimension",["macro",0]]],
      "vtp_enableEcommerce":false,
      ...
      "vtp_ci":"us-103525",
      "vtp_apv":"1",
      "vtp_apid":"PD73E393B-C1DF-42ED-A3AD-DE72E804EA72",
      "vtp_segb":"NA",
      "vtp_sfcode":"dcr",
      "vtp_sega":"NA",
      "vtp_assetname":"MI",
  ...
  "rules":[
    [["if",0],["add",0,1,2,3,4,20]],
    [["if",1,2],["add",5,10]],
    [["if",2,3],["add",5,11]],
    [["if",4,5],["add",6,8]],
    [["if",2],["add",7]],
    [["if",5,6],["add",9,17]],
    [["if",2,7],["unless",4],["add",12,19]],
    [["if",2,8],["add",13,18]],
    [["if",2,9],["add",14]],
    [["if",2,10],["add",15]],
    [["if",2,11],["add",16]]]
...
var gc={},hc=null;gc.m="GTM-MBTPXX";var ic=null,jc="//www.googletagmanager.com/a?id="+gc.m+"&cv=66",kc={},lc={};var mc=function(){},nc=function(a){return"function"==typeof a},oc=function(a){return"string"==ta(a)},pc=function(a){return"number"==ta(a)&&!isNaN(a)},qc=function(a){return Math.round(Number(a))||0},rc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},sc=function(a){var b=[];if(oa(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},tc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},uc=function(a,b){if(!pc(a)||!pc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
...
Z.a.ndcr=["nonGoogleScripts"],function(){(function(a){Z.__ndcr=a;Z.__ndcr.b="ndcr";Z.__ndcr.g=!0})(function(a){var b=[],c=X("NOLLite"),d=function(a,d,e){e&&c&&(d=c[a]||d);b.push(a+"="+encodeURIComponent(d))};d("nol_sfcode",a.vtp_sfcode);d("nol_ci",a.vtp_ci);d("nol_apid",a.vtp_apid);d("nol_apn",a.vtp_apn);d("nol_segA",a.vtp_sega,!0);d("nol_segB",a.vtp_segb,!0);d("nol_segC",a.vtp_segc,!0);d("nol_assetname",a.vtp_assetname,!0);d("nol_apv",a.vtp_apv);d("nol_vc",a.vtp_vc);var e=Y("https://seccdn-gl","http://cdn-gl",
".imrworldwide.com/novms/js/2/nlsDcrLite510.min.js#"+b.join("&"));J(e,a.vtp_gtmOnSuccess,a.vtp_gtmOnFailure)})}();
...
Z.a.csm=["nonGoogleScripts"],function(){(function(a){Z.__csm=a;Z.__csm.b="csm";Z.__csm.g=!0})(function(a){var b=X("document");P(function(a){if(2048<a.length){var b=a.substring(0,2040).lastIndexOf("&");a=a.substring(0,b)+"&ns_cut="+encodeURIComponent(a.substring(b+1));a=a.substring(0,2048)}return a}(function(a,c){var d=new Date,e=(c||"").split("&");c="";for(var k=0;k<e.length;k++)if(e[k]){var l=e[k].match(/([^=]*)=?(.*)/);c+="&"+encodeURIComponent(l[1])+"="+encodeURIComponent(l[2])}return Y("https://sb",
...
"http://b",".scorecardresearch.com/c2/"+encodeURIComponent(a.vtp_clientId)+"/cs.js");J(b,a.vtp_gtmOnSuccess,a.vtp_gtmOnFailure)};"complete"===b.readyState?c():Vf(X("self"),"load",c)})}();var Dg={macro:function(a){if(ge.Pa.hasOwnProperty(a))return ge.Pa[a]}};Dg.dataLayer=Dc;Dg.onHtmlSuccess=ge.Fb(!0);Dg.onHtmlFailure=ge.Fb(!1);Dg.callback=function(a){kc.hasOwnProperty(a)&&nc(kc[a])&&kc[a]();delete kc[a]};Dg.zc=function(){hc[gc.m]=Dg;lc=Z.a;Vb=Vb||ge;Wb=Qc};
